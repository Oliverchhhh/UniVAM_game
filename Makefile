...
check_dirs := src scripts tests/code train.py eval.py download_models.py download_datasets.py
exclude_dirs := tests/examples,scripts/datasets/download_robotwin.py
